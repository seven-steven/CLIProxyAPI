...
func main() {
	...
	flag.BoolVar(&codefreeLogin, "codefree-login", false, "Login to Codefree using OAuth")
	...
	} else if codefreeLogin {
		cmd.DoCodefreeLogin(cfg, noBrowser)
	} else {
